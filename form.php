...
<body>
  <div class="container-xxl position-relative bg-white d-flex p-0">
    ...
    <div class="content">
      ...
      <div class="container-fluid pt-4 px-4">
        ...
        <br>
        <h4 class="mb-4">Anualidades anticipadas</h4>
        <div class="row g-4">
        ...
        <br>
        <h4 class="mb-4">Anualidades Vencidas</h4>
        <div class="row g-4">
  ...
  <script src="js/ejercicios_anualidades.js"></script>
